...
<head>
    ...
    <link href="csss/main.css?v=11" rel="stylesheet" defer>
        ...
        <div class="container-fluid">
            ...
            <div>
                <div class="searchbar-div d-flex">
                    <span><img class="search-icon" src="./images/Untitled.webp"></span>
        ...
        <div class="row main-content">
            <div class=" banner-div  ">
                ...
                <div class="content text-center">
                    ...
                    <button type="button" class="btn btn-primary px-4 side-button" style="background-color: #21D0B3;  color: black;">Talk to Our Experts</button></p>
                </div>
            </div>
        </div>
    </div> -->
            ...
            <div class="row align-items-start ">
                <div class="col">
                    ...
                    <div class=".main-content text-center">
                        ...
                        <h2 class="text-white">LET’S INNOVATE DIGITALLY!</h2>
                        <p class="talk-expert mt-3">
                            <button type="button" class="btn btn-primary px-4 ">Talk to Our Experts</button>
                        </p>
