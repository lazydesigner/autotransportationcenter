...
require './phpMailer/src/SMTP.php';
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'info@getautotransportation.com';
    ...
    // $mail->Port= 465;
    // 
    $mail->setFrom('info@getautotransportation.com', 'getautotransportation');
    ...
    $mail->Subject = 'getautotransportation';
                    ...
                    <table class="wrap-table" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="center" style="padding: 0 15px 10px 15px">
                                <img src="https://getautotransportation.com/assets/img/GET%20AUTO%20.png"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="text-align: left">
                                    <tr>
                                        <td style="padding: 0px 0 15px 0">Hi, <b>'.$username.'</b><br>Thank you for your interest in shipping your vehicle
                                            with
                                            <b style="color: rgba(20, 20, 191, 0.897)">Get Auto Transportation</b>.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="
                            ...
                            <td style="background-color: #f2f2f2; padding: 30px 15px 30px 15px">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr>
                                        <td style="padding: 0px 0 15px 0">
                                            <b>Email:</b>
                                            <a target="_blank" href="mailto:info@getautotransportation.com"
                                                style="color: #000000 !important; text-decoration: none">info@getautotransportation.com</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0px 0 15px 0">
                                            <a target="_blank" href="https://www.getautotransportation.com"
                                                style="color: #000000 !important; text-decoration: none">www.getautotransportation.com</a>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr>
                                        <td style="padding: 0px 0 5px 0; font-size: 12px">
                                            This email was sent to you from Get Auto Transportation.
                                        </td>
                                    </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="text-align: left">
                                    <tr>
                                        <td style="padding: 0px 0 15px 0">Hi
                                            ...
                                            with
                                            <b style="color: rgba(20, 20, 181, 0.897)">Get Auto Transportation</b>.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="
